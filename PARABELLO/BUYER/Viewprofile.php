    ...
    <div class="container bg-dark text-white">
        <div class="row">
           <div class="col-sm-2"></div>
            <div class="col-sm-8">
                <label for=""><h1  class="text-white">USER ID:<?php echo $user?></h1></label>
            </div>
            <div class="col-sm-2">
        ...
        <?php 
        $qry=mysqli_query($con,"select * from buyer_register where no=$id")or die(mysqli_error($con));
        ...
        <div class="col-sm-4">
        <img src="photo/<?php echo $rec['photo']?>" alt="" width="100" height="100" class="rounded-circle">
        </div>
        <div class="col-sm-4">
        </div>
        </div>
...
<div class="row">
    ...
    <div class="col-sm-4">
    <a class="btn btn-outline-info btn-block " href="update details.php">Update details</a>
    </div>
    <div class="col-sm-4">
...
<div class="row">
    ...
    <div class="col-sm-4">
    <a class="btn btn-outline-info btn-block " href="changepassword.php">Change password</a>
    </div>
    <div class="col-sm-4">
...
<div class="row">
    ...
    <div class="col-sm-4">
     <button class="btn btn-outline-info btn-block">RETURN</button>
    </div>
    <div class="col-sm-4">
