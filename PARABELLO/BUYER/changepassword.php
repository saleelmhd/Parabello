...
else
{
 ...
 $epwd=$npwd=$cpwd=$error="";
if(isset($_POST['btn']))
{
    $epwd=$_POST['ep'];
    $npwd=$_POST['np'];
    $cpwd=$_POST['rp'];
    $qry=mysqli_query($con,"select * from login where username='$user' and password='$epwd' and id='$bid'")or die(mysqli_error($con));
if(mysqli_num_rows($qry))
{
 if($npwd==$cpwd)
 {
    mysqli_query($con,"update login set password='$npwd'  where id='$bid' and username='$user'") or die(mysqli_error($con));
...
<form action="" method="post">
         ...
         <div class="row">
          ...
          <div class="col-sm-8">
          <input type="password"  name="ep" class="form-control">
          </div>
         </div><br>
         <div class="row">
          <div class="col-sm-4">
         ...
         <div class="col-sm-4"><input type="submit" value="Update" name="btn" class="btn btn-outline-info btn-block"></div>
