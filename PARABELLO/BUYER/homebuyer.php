            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                              ...
                              <?php
                   $query=mysqli_query($con,"select * from parabello.add_car_details") or die(mysqli_error($con));
...
?>
                              <div class="col-sm-4">
                                <div class="card bg-dark">
                                                <div class="card-header"><h1 class="text-white"><?php echo $res['company']?></h1></div>
                                    <div class="card-body">
                                    
                    <img src="../SELLER/images/<?php echo $img ?>" alt="" width="200" height="200" class="img-responsive rounded" >
