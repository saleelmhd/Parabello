...
$qry=mysqli_query($con,"select * from buyer_register where no=$bid")or die(mysqli_error($con));
...
if(isset($_POST['btn']))
{
    ...
    mysqli_query($con,"update buyer_register set email='$email',mobile_no=$contact,city='$city',address='$address' where no='$bid'") or die(mysqli_error($con));
...
<body class="animsition">
    ...
    <div class="container  bg-dark text-white form-control">
