...
<body class="animsition">
    ...
    <div class="container bg-dark text-white">
            ...
            <?php
                   $query=mysqli_query($con,"select * from parabello.add_car_details where status='Available'") or die(mysqli_error($con));
...
?> 
            <div class="row "><!--row2-->
                    ...
                    <div class="col-sm-4 bg-dark">
                        <br>
                        <br>
                                <a class="btn btn-outline-info btn-block " href="svehichle more.php?sno=<?php echo $res['seller_no']?>&no=<?php echo $res['no']?>">more</a>
                     </div>
            </div><br>
            <?php
