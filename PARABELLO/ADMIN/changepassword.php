...
if(isset($_POST['btn']))
{
    ...
    $npwd=$_POST['np'];
    $cpwd=$_POST['rp'];
    $qry=mysqli_query($con,"select * from adminlogin where username='$user' and password='$epwd'")or die(mysqli_error($con));
if(mysqli_num_rows($qry))
{
 if($npwd==$cpwd)
 {
    mysqli_query($con,"update adminlogin set password='$npwd'  where username='$user'") or die(mysqli_error($con));
