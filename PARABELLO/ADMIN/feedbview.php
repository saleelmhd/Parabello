...
<div class="container bg-dark text-white">
            ...
            <?php
                   $query=mysqli_query($con,"select * from parabello.feedback") or die(mysqli_error($con));
...
?> 
                          ...
                          <!--  <div class="col-lg-12">
                                <div class="au-card bg-info recent-report">-->
                                    
                                   <table class="table">
                                   <tr class="bg-secondary text-white"><th> 
                   <?php echo $res['name'] ?></th></tr>
                   <tr class="text-white">
                   <td>
