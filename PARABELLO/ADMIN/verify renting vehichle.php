        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <table  class="table table table-dark table-responsive" border="1%""> 
                   ...
                   <?php
                   $query=mysqli_query($con,"select no,image,image2,image3,image4 from parabello.rent_car_details where priority=0") or die(mysqli_error($con));
...
while($res=mysqli_fetch_array($query))
{
    if(isset($_POST['btn'.$count]))
    {
        ...
        mysqli_query($con,"update rent_car_details set priority=$priority where no=".$res['no']) or die(mysqli_error($con));
