...
<div class="row">
    ...
    <div class="col-sm-4">
    <a role="button" class="btn btn-outline-info btn-block" href="update details.php">Update details</a>
    </div>
    <div class="col-sm-4">
...
<div class="row">
    ...
    <div class="col-sm-4">
    <a role="button" class="btn btn-outline-info btn-block" href="changepassword.php">Change password</a>
    </div>
    <div class="col-sm-4">
...
<div class="row">
    ...
    <div class="col-sm-4">
    <a role="button" class="btn btn-outline-info btn-block" href="home.php">Return</a>
    </div>
    <div class="col-sm-4">
