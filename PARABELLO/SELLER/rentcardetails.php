...
$price=$_POST['price'];
$status=$_POST['status'];
move_uploaded_file($_FILES['img1']['tmp_name'],getcwd().'/rimages/'.$_FILES['img1']['name'])	;
move_uploaded_file($_FILES['img2']['tmp_name'],getcwd().'/rimages/'.$_FILES['img2']['name'])	;
move_uploaded_file($_FILES['img3']['tmp_name'],getcwd().'/rimages/'.$_FILES['img3']['name'])	;
move_uploaded_file($_FILES['img4']['tmp_name'],getcwd().'/rimages/'.$_FILES['img4']['name'])	;

mysqli_query($con,"INSERT INTO parabello.rent_car_details(company,model,color,kms_driven,fuel_type,image,image2,image3,image4,city,rate,status,seller_no)VALUES('$company',$model,'$color',$kilometer,'$fuel','$image1','$image2','$image3','$image4','$city',$price,'$status','$sid')") or die(mysqli_error($con));
    }
    else
	{
...
<body class="animsition">
    ...
    <div class="container text-white">
        <form action="" method="post"  enctype="multipart/form-data" class="form-control text-white bg-dark">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="text-center text-white">ADD RENT CAR DETAILS</h1>
                </div>
            </div><br>
        <div class="row">
            <div class="col-sm-3">
        ...
        <div class="row">
            <div class="col-sm-3">
                <label for="">Price for one month</label>
            </div>
            <div class="col-sm-8">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
              <input type="submit" VALUE="Submit" name="btn" class="form-control">
            </div>
            <div class="col-sm-4">
