    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php
                   $query=mysqli_query($con,"select * from parabello.rent_car_details where seller_no=$sid") or die(mysqli_error($con));
...
?>
                    ...
                    <li><a href="renting all details.php?no=<?php echo $res['no']?>">-more</a></li>
                </ul>
                </td>
                <td>
                <a role="button" class="btn btn-outline-info btn-block" href="renting all details.php?no=<?php echo $res['no']?>">view</a>
                </td>
                    </tr>
                    <?php
