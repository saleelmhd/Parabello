...
{ 
 $record=mysqli_query($con,"select * from login  where role='SELLER' and username='".$_POST['txtUname']."' and id in(select no from seller_register where status=1)"); 
      ...
      <div class="row">
        ...
        <div class="col-sm-4  bg-transparent"><!--column2-->
          ...
          <!-- blank space close-->
                ...
                <div class="row"><!--row1-->
                <div class="col-sm-4"><label for="">Seller id:</label></div>
