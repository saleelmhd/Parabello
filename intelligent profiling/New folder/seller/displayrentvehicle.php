...
<head>
    ...
    <title>display rent vehicle2</title>
    <?php
...
<body>
<h1>List of Rent Vehicles</h1>

<?php
$query=mysqli_query($con,"select * from `add_vehicle_rent`") or die(mysqli_error($con));
...
<?php echo $res['rent_rate']?><br>
<?php echo $res['city']?></td>
<td>
    <a href="vehicle.php?rid=<?php echo $res['rentcar_id'] ?>">more</a>
