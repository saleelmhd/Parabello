...
mysqli_query($con,"INSERT INTO registration(user_id,name,email,password,adhar_num,address,roll) VALUES('$name',$number,'$mail','$pass',$adhar,'$address')") or die(mysqli_error($con));
}
?>
