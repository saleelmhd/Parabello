...
<head>
    ...
    mysqli_query($con,"INSERT INTO add_vehicle_seller(company,model,color,kms_driven,fuel_type,image,image2,image3,city,rate) VALUES('$company',$model,'$color','$kms','$ftype','$img1','$img2','$img3','$city','$rate')") or die(mysqli_error($con));
