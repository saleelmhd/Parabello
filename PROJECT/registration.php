...
mysqli_query($con,"INSERT INTO registraion(user_id,name,email,password,adhar_num,address) VALUES('$name',$number,'$mail','$pass',$adhar,'$address')") or die(mysqli_error($con));
}
?>
...
<label for="ADDRESS">ADDRESS</label><input type="text" name="adhrnum" placeholder="Address ...">
<p>
